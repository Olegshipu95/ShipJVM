#ifndef SHIP_JVM_BYTECODES_OPCODE_TABLE_H
#define SHIP_JVM_BYTECODES_OPCODE_TABLE_H
...
#ifndef BYTECODE_OPCODES_IMPL
extern const struct runtime_opcode OPCODE_TABLE[OPCODES_NUMBER];
#endif
