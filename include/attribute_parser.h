...
int parse_EnclosingMethod_at(Loader* loader, struct EnclosingMethod_attribute*);
...
int parse_lineNumberTable_at(Loader* loader, struct LineNumberTable_attribute*);
int parse_LocalVariableTable_at(Loader* loader,
                                struct LocalVariableTable_attribute*);
int parse_LocalVariableTypeTable_at(Loader* loader,
...
int parse_ModulePackages_at(Loader* loader, struct ModulePackages_attribute*);
int parse_ModuleMainClass_at(Loader* loader, struct ModuleMainClass_attribute*);
